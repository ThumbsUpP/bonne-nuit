        ...
        <div className="bg-white rounded-2xl shadow-2xl p-8">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-500 mt-1">
              {isSignUp ? 'Start creating magical stories' : 'Sign in to continue'}
            </p>
          </div>
          ...
          <div className="mt-6">
            ...
            <button
              ...
              disabled={loading}
              className="mt-4 w-full bg-white border border-gray-200 hover:bg-gray-50 text-gray-700 font-semibold py-3 rounded-xl transition-all flex items-center justify-center gap-2"
            >
